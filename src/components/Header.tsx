      ...
      <div className="w-full max-w-[1280px] mx-auto p-4 flex justify-between items-center">
        <div className="flex justify-start items-center gap-3">
          <div className="inline-flex flex-col justify-start items-start">
            <div className="w-10 h-10 bg-gradient-to-br from-green-600 to-green-800 rounded-xl shadow-[0px_2px_4px_-2px_rgba(0,0,0,0.10)] shadow-md inline-flex justify-center items-center overflow-hidden">
              <span className="text-white text-xl font-bold font-['Poppins']">Y</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center">
              <span className="text-red-600 text-xl font-bold font-['Poppins'] leading-7">You</span>
              <span className="text-slate-800 text-xl font-bold font-['Poppins'] leading-7">can</span>
              <span className="text-green-600 text-xl font-bold font-['Poppins'] leading-7">win</span>
            </div>
